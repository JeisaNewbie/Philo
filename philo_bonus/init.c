...
/*   Updated: 2023/05/06 13:41:30 by jhwang2          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	creat_sem(t_data *philos)
{
	...
	philos->sem->sem_setting = sem_open ("sem_setting", O_CREAT, 0666, 1);
	if (philos->sem->sem_setting == SEM_FAILED)
		return (close_sem (philos, 4));
